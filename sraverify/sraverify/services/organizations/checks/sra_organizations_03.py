...
class SRA_ORGANIZATIONS_03(OrganizationsCheck):
    ...
    meta = CheckMeta(
        check_id="SRA-ORGANIZATIONS-03",
        title="Organization has foundational OU - Infrastructure",
        description=(
        ...
        remediation=Remediation(
            text=(
                "Create an organizational unit named Infrastructure directly under "
                "the organization root and move the shared services and networking "
                "accounts into it."
            ),
            cli=(
                "aws organizations create-organizational-unit "
                "--parent-id <root-id> --name Infrastructure"
            ),
            console=(
                "AWS Organizations console, AWS accounts, select Root, "
                "Actions, Create new, name the OU Infrastructure."
            ),
        ),
    )
    ...
    def execute(self) -> Iterable[Finding]:
        ...
        Yields:
            One Finding for the Infrastructure OU.
        """
