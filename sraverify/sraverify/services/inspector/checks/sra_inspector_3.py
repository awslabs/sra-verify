"""
SRA-INSPECTOR-3: Inspector ECR Image Vulnerability Scanning.
"""
            ...
            if not account_status or ecr_status != 'ENABLED':
                self.findings.append(
                    self.create_finding(
                        ...
                        resource_id=f"inspector2/{account_id}/ecr",
                        ...
                        remediation=(
                            ...
                            f"aws inspector2 enable --account-ids {account_id} --resource-types ECR --region {region}"
                        )
                    )
                )
            else:
